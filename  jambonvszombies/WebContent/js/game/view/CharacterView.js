Game.Views.Character = Backbone.View.extend({
	 ...
	 */
	update : function() {
		var dir, camera = Game.Controllers.App.camera;
	...
	/*
	 * function setPosition utility function to set position of both boundingMesh and sprite at the same time
	 */
	...
	/*
	 * function moveCharacter translates x, y coordinates to world space and updates character
	 */
	moveCharacter : function(e) {
		var camera = Game.Controllers.App.camera, projector = Game.Controllers.App.projector, x, y, t;
		...
		// Start walking
		this.goalVector.set(this.startVector.x + t * this.dirVector.x, this.startVector.y + t * this.dirVector.y, this.startVector.z + t * this.dirVector.z);
