Game.Views.App = Backbone.View.extend({
	...
	/*
	 * function renderLand Renders the landscape of the world and attaches to scene
	 */
	initLand : function() {
		var grass, plane, uvs, i, j, mesh;

		// Load texture
		grass = THREE.ImageUtils.loadTexture("textures/terrain/grasslight-big.jpg");
	...
	/*
	 * function clickWorld Handles clicks for the entire world, since we don't really have sub-elements of the canvas
	 */
